  ...
  tabs: {
    theory: `
      ...
      <div class="illustration bordered">
        ...
        <div class="caption">Контуры функции $f(x,y) = x^2 + 3y^2$ — это эллипсы (всё более широкие по $y$, так как $y$ входит с бо́льшим коэффициентом). Красные стрелки — градиенты: они всегда направлены «наружу», перпендикулярно контурам, в сторону возрастания $f$.</div>
      </div>
      ...
      <ul>
        ...
        <li><b>Sedle points</b> (сёдла): где градиент = 0, но это не минимум и не максимум.</li>
      </ul>
