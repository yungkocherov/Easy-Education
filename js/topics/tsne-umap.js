...
plt.show()</code></pre>
    ...
    applications: `
      ...
      <table>
        ...
        <tr><td><b>NLP</b></td><td>Визуализация <a class="glossary-link" onclick="App.selectTopic('glossary-embedding')">эмбеддингов</a> слов/документов — проверка качества представлений</td></tr>
