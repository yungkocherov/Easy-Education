  ...
  tabs: {
    theory: `
      ...
      <div class="key-concept">
        ...
        <p><span class="term" data-tip="DAG (Directed Acyclic Graph): ориентированный граф без циклов, где рёбра — причинные связи. Позволяет формально идентифицировать конфаундеры, медиаторы и коллайдеры.">DAG</span> (направленный ациклический граф) — язык для формальной записи причинных предположений. Пример: Жара → Мороженое, Жара → Купание → Утопления. Контролируя Жару (conditioning on), разрываем ложную корреляцию между Мороженым и Утоплениями. DAG помогает решить: что нужно контролировать, а что — нет (не контролируй коллайдер!).</p>
      </div>
...
print(refute)  # Если ATE не изменился при добавлении случайного конфаундера — хороший знак</code></pre>
    ...
    links: `
      <h3>📺 Видео</h3>
      <ul>
        <li><a href="https://www.youtube.com/watch?v=zvrcyqcN9Nk" target="_blank">Brady Neal: Introduction to Causal Inference (Course)</a> — полный курс по причинно-следственному анализу</li>
        <li><a href="https://www.youtube.com/watch?v=Od6oAz1Op2k" target="_blank">StatQuest: Logistic Regression and Propensity Scores</a> — оценки склонности и PSM</li>
        <li><a href="https://www.youtube.com/watch?v=WwW8y5dZs80" target="_blank">StatQuest: Difference-in-Differences</a> — метод разностей-в-разностях для оценки причинного эффекта</li>
      </ul>
      <h3>📖 Статьи</h3>
      <ul>
        <li><a href="https://habr.com/ru/search/?q=causal+inference+%D0%BF%D1%80%D0%B8%D1%87%D0%B8%D0%BD%D0%BD%D0%BE%D1%81%D1%82%D1%8C" target="_blank">Habr: causal inference</a> — статьи о причинно-следственном анализе на Хабре</li>
