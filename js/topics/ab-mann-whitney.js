...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <div class="callout warn">Манн-Уитни не спасает от всех проблем с данными. Если в данных есть ошибки измерений, систематические смещения или нарушения независимости наблюдений — никакой тест не поможет.</div>
    `,
