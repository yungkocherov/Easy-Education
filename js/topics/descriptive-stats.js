...
plt.show()  # Выброс 450 виден как отдельная точка</code></pre>
    ...
    applications: `
      ...
      <p><b>Описательные статистики скрывают форму распределения.</b> <b>Квартет Анскомба</b> — четыре датасета с одинаковыми mean, std и корреляцией, но совершенно разными формами (прямая, парабола, выброс, и т.д.). Смотреть только на числа — значит не видеть дырок в данных. Всегда рисуй график рядом.</p>
