...
plt.show()
    ...
    applications: `
      ...
      <ul>
        ...
        <li><b><a class="glossary-link" onclick="App.selectTopic('viz-heatmap')">Heatmap / 2D histogram</a></b> — ещё один способ показать плотность при миллионах точек. Читается как тепловая карта, идеально для очень больших данных.</li>
