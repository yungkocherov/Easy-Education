...
plt.show()
    ...
    applications: `
      ...
      <ul>
        ...
        <li><b><a class="glossary-link" onclick="App.selectTopic('viz-kde')">KDE plot</a></b> (наложенные кривые) — если хочешь сравнить формы 3–4 групп без привязки к квартилям: чище, чем скрипки бок о бок.</li>
      </ul>
    `,
