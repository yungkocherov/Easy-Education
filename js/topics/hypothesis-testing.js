...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <div class="callout warn">Чем меньше α (строже тест), тем больше β. Эти ошибки связаны: уменьшая одну, увеличиваешь другую. Единственный способ уменьшить обе — взять больше данных.</div>
