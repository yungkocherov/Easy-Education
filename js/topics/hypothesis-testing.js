...
# Две пропорции (бинарная метрика)         → proportions_ztest</code></pre>
    ...
    proscons: `
      ...
      <div class="callout warn">⚠️ При <a class="glossary-link" onclick="App.selectTopic('glossary-multiple-testing')">многократных сравнениях</a> нужны поправки (Бонферрони, FDR), иначе ошибки I рода накапливаются.</div>
    `,
