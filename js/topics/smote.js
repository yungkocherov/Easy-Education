  ...
  tabs: {
    theory: `
      <div class="intuition">
        ...
        <p>Нужны специальные техники, чтобы модель «обращала <a class="glossary-link" onclick="App.selectTopic('glossary-attention')">внимание</a>» на редкий класс. SMOTE — одна из них: синтезирует новых «отличников» на основе существующих, делая класс более заметным.</p>
      </div>
