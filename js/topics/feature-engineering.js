...
for train_idx, val_idx in kf.split(df):
    ...
    proscons: `
      ...
      <ul>
        <li><b>Нейросети на больших данных</b> — глубокие нейросети обучаются представлениям (<a class="glossary-link" onclick="App.selectTopic('glossary-embedding')">embeddings</a>) самостоятельно; на изображениях и тексте ручной FE почти не нужен</li>
