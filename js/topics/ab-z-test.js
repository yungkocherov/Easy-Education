...
plt.show()</code></pre>
    ...
    applications: `
      <h3>Где применяется z-тест для пропорций</h3>
      <table>
        <tr><th>Область</th><th>Задача</th></tr>
        <tr><td><b>A/B тестирование</b></td><td>Сравнение конверсии (регистрация, покупка, клик) — самый частый случай</td></tr>
        <tr><td><b>Контроль качества</b></td><td>Сравнение доли брака между партиями</td></tr>
        <tr><td><b>Опросы</b></td><td>Сравнение доли «да/нет» между группами респондентов</td></tr>
        <tr><td><b>Медицина</b></td><td>Сравнение частоты побочных эффектов или эффективности (большие выборки)</td></tr>
        <tr><td><b>Маркетинг</b></td><td>Сравнение CTR рекламных креативов</td></tr>
        <tr><td><b>Одновыборочный вариант</b></td><td>Проверка: достигла ли конверсия бизнес-целевого показателя</td></tr>
      </table>
      <p><b>Когда использовать:</b> обе выборки &gt; 30, конверсии не близки к 0% или 100%, np &gt; 5 и n(1-p) &gt; 5.</p>
    `,
