...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <div class="callout warn">Переключать тест с двустороннего на односторонний после просмотра данных — грубая форма p-hacking. Выбирай тип теста ДО запуска.</div>
