...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <h3><a class="glossary-link" onclick="App.selectTopic('glossary-overfitting')">Переобучение</a> и <a class="glossary-link" onclick="App.selectTopic('glossary-overfitting')">недообучение</a></h3>
