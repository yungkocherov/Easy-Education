...
print(classification_report(y_test, y_pred,
    ...
    applications: \`
      <h3>Где применяется ML</h3>
      <table>
        <tr><th>Область</th><th>Задача</th><th>Тип</th></tr>
        <tr><td>E-commerce</td><td>Рекомендация товаров, прогноз спроса</td><td>Классификация, регрессия</td></tr>
        <tr><td>Финансы</td><td>Скоринг, детекция фрода</td><td>Классификация</td></tr>
        <tr><td>Медицина</td><td>Диагностика по снимкам, прогноз риска</td><td>Классификация, регрессия</td></tr>
        <tr><td>NLP</td><td>Перевод, чат-боты, суммаризация</td><td>Seq2seq, классификация</td></tr>
        <tr><td>Транспорт</td><td>Автопилот, оптимизация маршрутов</td><td>RL, регрессия</td></tr>
        <tr><td>Маркетинг</td><td>Сегментация клиентов, churn-прогноз</td><td>Кластеризация, классификация</td></tr>
        <tr><td>Промышленность</td><td>Предиктивное обслуживание, контроль качества</td><td>Регрессия, аномалии</td></tr>
      </table>
    \`,
    ...
    proscons: \`
      <h3>Плюсы ML</h3>
      <ul>
        <li><b>Автоматизация</b> — модель находит паттерны, которые человек может пропустить</li>
        <li><b>Масштабируемость</b> — обучил один раз, предсказываешь миллионы раз</li>
        <li><b>Адаптивность</b> — модель переобучается на новых данных</li>
        <li><b>Сложные зависимости</b> — работает с сотнями признаков и нелинейными связями</li>
      </ul>

      <h3>Минусы и ограничения</h3>
      <ul>
        <li><b>Нужны данные</b> — без качественных данных ML бесполезен (garbage in → garbage out)</li>
        <li><b>Чёрный ящик</b> — сложные модели (нейросети, бустинг) трудно интерпретировать</li>
        <li><b>Переобучение</b> — модель может «запомнить» данные вместо закономерностей</li>
        <li><b>Bias в данных</b> — модель воспроизводит предубеждения, заложенные в тренировочных данных</li>
        <li><b>Ресурсы</b> — обучение больших моделей требует GPU, времени и денег</li>
      </ul>
    \`,
