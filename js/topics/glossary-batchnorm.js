...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <p>Эта двойственность — источник многих багов. Забыли `model.eval()` → BN использует статистики текущего батча, и предсказания зависят от того, с кем объект подавался.</p>
