  ...
  tabs: {
    theory: `
      <div class="intuition">
        ...
        <p>Представь, что ты хочешь оценить стоимость дома и звонишь 100 независимым оценщикам. Каждый смотрит на немного разные характеристики: один акцентирует <a class="glossary-link" onclick="App.selectTopic('glossary-attention')">внимание</a> на расстоянии до метро, другой — на площади кухни, третий — на этаже. Каждый называет своё число. Ты берёшь <b>среднее всех оценок</b>.</p>
