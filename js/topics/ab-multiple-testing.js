...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <div class="callout warn"><b>p-hacking</b> — это неявное множественное сравнение: перебор подгрупп, метрик, временных периодов до нахождения «значимого» результата. Поправки не спасают от p-hacking — только pre-registration.</div>
    `,
