...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <p><b>Обрати <a class="glossary-link" onclick="App.selectTopic('glossary-attention')">внимание</a>:</b> никакой оптимизации, никакого выбора «лучшего» сплита — просто случайность. Это и есть магия алгоритма.</p>
