...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <ul>
        <li><b>Токенизация:</b> разбить текст на отдельные единицы (слова, подслова). «Я иду домой» → ['я', 'иду', 'домой'].</li>
      ...
      <h3>📊 TF-IDF: взвешенный подсчёт</h3>
      ...
      <div class="deep-dive">
        ...
        <div class="deep-dive-body">
          <p><b>Byte Pair Encoding (BPE)</b> — алгоритм токенизации, используемый в GPT, RoBERTa. Вместо слов токенами могут быть части слов («play», «##ing», «##ed»).</p>
    ...
    examples: [
      {
        ...
        content: `
          ...
          <div class="step" data-step="4">
            ...
            <div class="calc">
              Косинусное сходство d1 и d3:<br>
