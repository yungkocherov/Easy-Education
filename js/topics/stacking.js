  ...
  tabs: {
    theory: `
      <div class="intuition">
        ...
        <p>Это и есть stacking. <b>Эксперты — базовые модели (уровень 0)</b>: Random Forest, Gradient Boosting, Логистическая регрессия. <b>Арбитр — мета-модель (уровень 1)</b>: она обучается на предсказаниях базовых моделей и учится, кому и когда доверять.</p>
      ...
      <ul>
        ...
        <li><b>Простая мета-модель</b> — логистическая регрессия или Ridge лучше, чем сложная. Мета-признаков мало (3–10), риск переобучения высок.</li>
