...
App.registerTopic({
  ...
  tabs: {
    theory: `
      ...
      <ul>
        <li><b>k = 1</b>: предсказываем значение буквально ближайшей точки. Высокая дисперсия, переобучение — «запомнили» каждый выброс.</li>
        <li><b>k = 5-15</b>: обычно хороший баланс. Сглаживает шум, но отслеживает локальные паттерны.</li>
        <li><b>k = n</b>: предсказываем среднее всего датасета для всех точек. Максимальное смещение, недообучение.</li>
      </ul>
